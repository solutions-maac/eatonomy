...
class OrderConfirmChatCard extends StatelessWidget {
  final bool? sender;
  final ChatController?controler;
  const OrderConfirmChatCard({Key? key, this.sender, this.controler}) : super(key: key);
      ...
      children: [
        Text.rich(
          TextSpan(
            children: [
              TextSpan(
                text: 'Thank you,\nYour menu order has been confirmed.\nYou will get pick up service from ',
                style: TextStyle(
              ...
              TextSpan(
                text: 'Saturday, 13 Jan - 3.30pm\nSaturday, 13 Jan - 3.30pm\nSaturday, 13 Jan - 3.30pm\nSaturday, 13 Jan - 3.30pm\nSaturday, 13 Jan - 3.30pm\nSaturday, 13 Jan - 3.30pm\nSaturday, 13 Jan - 3.30pm',
                style: TextStyle(
                  color: sender!? Colors.white:textColor,
                  fontSize: 12,
                  fontFamily: 'Satoshi',
